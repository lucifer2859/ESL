...
# public leaderboard
# mode 0 : 897 | 5000   0.85422
# mode 1 : 933 | 5000   0.86874
# mode 2 : 530 | 3000   0.85955 (SRResNet)
# mode 3 : 797 | 13600   0.85081 (EDSR)
...
class CNN(nn.Module):
    def __init__(self):
        ...
        # self.res = ResBlock(channels=64, mode=0)
        # self.res = ResBlock(channels=64, mode=1)
        # self.res = ResBlock(channels=64, mode=2)
        self.res = ResBlock(channels=64, mode=3)
...
if __name__ == "__main__":
    ...
    if (len(sys.argv) == 2):
        if sys.argv[1] == 'test':
            ...
            print('Usage: python cnn12.py [train/test]')
            print('       Default: train')
            exit(0)
    elif (len(sys.argv) > 2):
        print('Usage: python cnn12.py [train/test]')
