...
# public leaderboard
# data_aug_mode=1   2223 | 4000   0.87925
# data_aug_mode=2   187  | 523    0.87666
# data_aug_mode=3   48   | 137    0.85896
...
if __name__ == "__main__":
    ...
    if (len(sys.argv) == 2):
        if sys.argv[1] == 'test':
            ...
            print('Usage: python cnn15.py [train/test]')
            print('       Default: train')
            exit(0)
    elif (len(sys.argv) > 2):
        print('Usage: python cnn15.py [train/test]')
    ...
    if (train):
        ...
        # trainloader = load_data(train_path, data_aug_mode=2)
        trainloader = load_data(train_path, data_aug_mode=3)
