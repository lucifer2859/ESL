...
# public leaderboard
# 76   | 2500 : 0.69511 (With ReLU)
# 237  | 2500 : 0.67933 (With Sigmoid)
# 209  | 2500 : 0.65740 (With Tanh)
# 258  | 2500 : 0.64488 (With scaled Tanh)
...
if __name__ == "__main__":
    ...
    if (len(sys.argv) == 2):
        if sys.argv[1] == 'test':
            ...
            print('Usage: python nn2.py [train/test]')
            print('       Default: train')
            exit(0)
    elif (len(sys.argv) > 2):
        print('Usage: python nn2.py [train/test]')
