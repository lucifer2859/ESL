...
# public leaderboard
# 1380 | 2000 : 0.48014 (Without Activation Fuctions)
# 399  | 2000 : 0.68607 (With ReLU)
# 387  | 2000 : 0.67651 (With Sigmoid)
# 720  | 2000 : 0.67703 (With Tanh)
# 714  | 2000 : 0.67770 (With scaled Tanh)
...
if __name__ == "__main__":
    ...
    if (len(sys.argv) == 2):
        if sys.argv[1] == 'test':
            ...
            print('Usage: python nn1.py [train/test]')
            print('       Default: train')
            exit(0)
    elif (len(sys.argv) > 2):
        print('Usage: python nn1.py [train/test]')
